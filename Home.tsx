/**
 * Home Page - Data Dictionary
 * 
 * Design Philosophy: Modern Technical Documentation
 * - Left sidebar with hierarchical schema tree
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-foreground">
                {activeTable ? activeTable.name : activeModule?.name || 'Data Dictionary'}
              </h2>
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-6xl mx-auto p-6">
            {activeTable ? (
              ...
              <ModuleOverview module={activeModule} onTableSelect={handleTableSelect} />
            ) : (
              <div className="text-center py-12">
                <p className="text-muted-foreground">Chọn một module từ sidebar để bắt đầu</p>
              </div>
            )}
          </div>
        </div>
